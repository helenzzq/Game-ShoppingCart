...
export default function Summary(props) { 
    const { ItemInCart:itemInCart, addItem ,removeAll,deleteItem} = props;
    ...
    function DisplaySummary() {
        ...
        const subtotal = itemInCart.reduce((a, c) => a + c.price * c.qty, 0);
        ...
        <hr />
        <div className="row">
          <button onClick={() => alert('Jump To CheckOut Page !')}>
            Checkout
          </button>
        </div>
      </>
